<head>
    ...
    <link rel="shortcut icon" type="image/ico" href="[[++base_url]]assets/img/favicon.png">
    <link rel="apple-touch-icon" sizes="144x144" href="[[++base_url]]assets/img/touch-icon.png">
    <base href="startertheme">
    [[-<link rel="stylesheet" type="text/css" href="[[modxMinify? &group=`css`]]" />]]
    <link rel="stylesheet" type="text/css" href="[[++base_url]]startertheme/assets/scss/style.css" />
    ...
    <script id="loadcss__webfonts">loadLocalStorageCSS("webfonts", "https://fonts.googleapis.com/css?family=Playfair+Display|Roboto");</script>
