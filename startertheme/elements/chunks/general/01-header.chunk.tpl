...
<div class="header-image" style="background-image: url([[++header-image]]);">
    <div class="header-image-inner header-full-height">
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                        <a href="[[~[[++site_start]]]]" class="logo">[[++logo:len:gt=`22`:then=`<img src="[[++logo]]" alt="[[++site_name]]">`:else=`[[++site_name]]`]]</a>
                    </div>
                </div>
            </div>   
            <div id="main-sticky-menu" class="main-navigation-wrapper" style="background-image: url([[++header-image]]);"> 
                <div class="container">
                    <div class="row">       
                        <div class="col-12">
