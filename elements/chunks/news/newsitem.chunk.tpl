<div class="overview--item" itemscope itemtype="http://schema.org/NewsArticle">
    <a href="[[+id:makeUrl]]" title="[[+longtitle:default=`[[+pagetitle]]`]]" itemprop="url">
        <div class="row">
            ...
            <div class="col-12 col-md-8 [[+idx:mod:isequalto=`1`:then=``:else=`order-2 order-md-1`]]">
                <div class="overview--content">
                    ...
                    <span class="overview--date">
                        ...
                        <meta itemprop="datePublished" content="[[+publishedon:formatDate=`%Y-%m-%dT%H:%M:%S%z`]]" />
                        <meta itemprop="dateModified" content="[[+publishedon:formatDate=%`Y-%m-%dT%H:%M:%S%z`]]" />
                    </span>
